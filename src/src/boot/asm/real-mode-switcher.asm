...
section .text
    ...
    reloc: use32                               ; by Napalm
        ...
        jmp  word 0x18:REBASE(p_mode16)      ; switch to 16bit selector (16bit protected mode)
    p_mode16: use16
        mov  ax, 0x20                        ; get our 16bit data selector
    ...
    ib: db 0x00
        ...
        mov  cr0, eax                          ; set cr0 to result
        jmp  dword 0x08:REBASE(p_mode32)     ; switch to 32bit selector (32bit protected mode)
    p_mode32: use32
